class AcceptPreauthorizedConversationsController < ApplicationController
  ...
  def render_payment_form(preselected_action, payment_type)
    ...
    render "accept", locals: {
      ...
      seller_gets: @transaction.payment_total - (@transaction.commission || 0) - (@transaction.buyer_commission || 0),
      form: @transaction,
      ...
      base_exchange_rate: @transaction.exchange_rate
    }
  end
