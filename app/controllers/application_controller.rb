...
class ApplicationController < ActionController::Base
  ...
  def warn_about_missing_payment_info
    if @current_user
      ...
      chilean_bank_ready = @current_user.chilean_bank_account.present?
      ...
      if (has_paid_listings && accept_payments.blank? && !admin_controller?) || (has_paid_listings && !chilean_bank_ready)
        payment_settings_link = view_context.link_to(t("paypal_accounts.from_your_payment_settings_link_text"),
          new_chilean_bank_account_path, target: "_blank", rel: "noopener")
