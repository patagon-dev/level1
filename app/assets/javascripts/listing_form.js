    ...
    module.listingForm = $(form_id).validate({
      errorPlacement: function(error, element) {
        if (element.attr("name") == "listing[valid_until(1i)]") {
          ...
          error.insertAfter($(".listing-image-error"));
        } else {
      ...
      rules: _.extend(numericRules, {
        ...
        "listing_images[][id]": {listing_image_required: true}
      }),
      messages: {
        ...
        "listing_images[][id]": {listing_image_required: "Es obligatorio subir al menos 1 imagen."}
      },
