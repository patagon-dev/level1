...
class TransactionMailer < ActionMailer::Base
  ...
  def payment_receipt_to_seller(transaction, seller_model = nil, buyer_model = nil, community = nil)
    ...
    payment_total = transaction.payment_total #payment[:payment_total]

    service_fee = transaction.commission#service_fee_calc(payment, transaction, payment_total)
    buyer_service_fee = transaction.buyer_commission || Money.new(0, payment_total.currency)
  ...
  def payment_receipt_to_buyer(transaction, seller_model = nil, buyer_model = nil, community = nil)
    ...
    buyer_service_fee = transaction.buyer_commission
