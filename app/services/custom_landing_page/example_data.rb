    ...
    DATA_STR = <<JSON
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraph": "Text paragraphs can contain Markdown markup MALDONADO. Limited subset of Markdown syntax blocks are allowed. Allowed blocks are *italic*, **bold**, ***bold+italic***, ~~strike through~~, _underline_ and [links](https://www.sharetribe.com).  \\nLine breaks and...\\n\\n...new paragraphs are also supported"
    },
    {
