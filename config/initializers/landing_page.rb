    ...
    DATA_STR = <<JSON
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "title": "Si eres Proveedor de Servicios, regístrate y llega a miles de clientes en todo Chile.",
      "paragraph": "Luego recibe los pagos **directamente** en tu Cta. Bancaria después de realizado el Servicio."
    },
    {
      "id": "markdown_support",
      "kind": "info",
      ...
      "paragraph": "Busca y agenda clases particulares y servicios en tu Comuna. Paga para reservar, y **libera el pago después** de realizado el servicio. Califica."
    },
    {
    ...
    },
    {
        ...
        "paragraph": "Buscar servicios por Categoría",
        "button_color": {"type": "marketplace_data", "id": "primary_color"},
        "button_color_hover": {"type": "marketplace_data", "id": "primary_color_darken"},
        "button_title": "Ver todas las categorías",
    ...
    },
    {
      ...
      "links": [
        ...
        {"label": "Contáctenos", "href": {"type": "path", "id": "contact_us"}},
        {"label": "¿Cómo funciona?", "href": {"type": "path", "id": "how_to_use"}},
        {"label": "Términos", "href": {"type": "path", "id": "terms"}},
